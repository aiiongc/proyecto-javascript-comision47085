        ...
        case "1":
            let mediosPago = prompt ('¿Con qué medio de pago pagas? \n1 - Debito \n2 - Credito');
                switch (mediosPago) {
                    ...
                    case "2":
                        alert('¡Tu compra está casi lista!');
                        let bancos1 = prompt('El total es 20 USD. Por favor, selecciona a tu banco para completar el proceso \n1 - Banco Estado \n2 - Banco BBVA \n3 - Banco Santander');
                        switch (bancos1) {
                            case "1": 
                                login();
                            case "2":
        ...
        case "2":
            let mediosPago2 = prompt ('¿Con qué medio de pago pagas? \n1 - Debito \n2 - Credito');
                switch (mediosPago2) {
                    ...
                    case "2":
                        alert('¡Tu compra está casi lista!');
                        let bancos22 = prompt('El total es 15 USD. Por favor, selecciona a tu banco para completar el proceso \n1 - Banco Estado \n2 - Banco BBVA \n3 - Banco Santander');
                        switch (bancos22) {
                            case "1": 
                                login();
                            case "2":
        ...
        case "3":
            let mediosPago3 = prompt ('¿Con qué medio de pago pagas? \n1 - Debito \n2 - Credito');
                switch (mediosPago3) {
                    case "1":
                        alert('¡Tu compra está casi lista!')
                        let bancos3 = prompt('El total es 15USD. Por favor selecciona a tu banco para completar el proceso \n1 - Banco Estado \n2 - Banco BBVA \n3 - Banco Santander');
                        switch (bancos3) {
                            case "1": 
                                login();
                            case "2":
                    ...
                    case "2":
                        alert('¡Tu compra está casi lista!');
                        let bancos33 = prompt('El total es 15USD. Por favor, selecciona a tu banco para completar el proceso \n1 - Banco Estado \n2 - Banco BBVA \n3 - Banco Santander');
                        switch (bancos33) {
                            case "1": 
                                login();
                            case "2":
        ...
        case "4":
            let mediosPago4 = prompt ('¿Con qué medio de pago pagas? \n1 - Debito \n2 - Credito');
                switch (mediosPago4) {
                    case "1":
                        alert('¡Tu compra está casi lista!')
                        let bancos4 = prompt('El total es 30 USD. Por favor selecciona a tu banco para completar el proceso \n1 - Banco Estado \n2 - Banco BBVA \n3 - Banco Santander');
                        switch (bancos4) {
                            case "1": 
                                login();
                            case "2":
                    ...
                    case "2":
                        alert('¡Tu compra está casi lista!');
                        let bancos44 = prompt('El total es 30 USD. Por favor, selecciona a tu banco para completar el proceso \n1 - Banco Estado \n2 - Banco BBVA \n3 - Banco Santander');
                        switch (bancos44) {
                            case "1": 
                                login();
                            case "2":
